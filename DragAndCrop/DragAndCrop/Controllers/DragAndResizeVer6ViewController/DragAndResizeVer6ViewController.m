//
//  DragAndResizeVer6ViewController.m
//  DragAndCrop
//
...
@interface DragAndResizeVer6ViewController () {
...
@implementation DragAndResizeVer6ViewController
...
- (void)viewDidLoad {
    ...
    _areaView        = [[UIView alloc] initWithFrame:CGRectMake(0, 0, width, width / scale)];
