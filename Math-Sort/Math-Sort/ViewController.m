...
//  Math-Sort
//
//  Created by YouXianMing on 2017/8/9.
...
//    // 选择排序
//    showArray([self selectionSort:randomsValues(8)]);
//    
//    // 冒泡排序
//    showArray([self bubbleSort:randomsValues(8)]);
//    
//    // 插入排序
//    showArray([self insertionSort:randomsValues(8)]);
//    
//    // 归并排序
//    showArray([self mergeSort:randomsValues(8)]);
//    
    // 快速排序
    showArray([self quickSort:randomsValues(8)]);
}
